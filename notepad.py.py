...
class Notepad:
    ...
    def __init__(self,**kwargs):
        ...
        # Set the window text
        self.__root.title("Untitled - Sid Notepad")
        ...
        self.__thisHelpMenu.add_command(label="About Sid Notepad",
    ...
    def __showAbout(self):
        showinfo("Sid Notepad", "\n Projet Name : Sid Notepad \n\n version : 1.0.20.6 \n\n Create BY : SIDDHARTH  \n\n Roll No : 16015014019 \n\n Date : 21/06/2018 ")
    ...
    def __saveFile(self):
        ...
        if self.__file == None:
            ...
            if self.__file == "":
                ...
                self.__root.title(os.path.basename(self.__file) + " - Sid Notepad")
    ...
    def __replace(self):
        self.__thisTextArea.event_generate("<<Replace>>")
